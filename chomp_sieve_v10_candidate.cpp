// V10 candidate based on validated V9. See the accompanying validation report.
#include <algorithm>
#include <atomic>
#include <chrono>
#include <cstdint>
...
int main(int argc,char**argv){
 try{
    if(argc<2){std::cerr<<"usage: chomp_sieve_v10_candidate ppositions.bin [max-dimension] [checkpoint] [preload-checkpoint] [only-width] [only-height] [threads]\n";return 2;}
