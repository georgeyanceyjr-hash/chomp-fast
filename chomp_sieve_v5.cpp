// V5: use 64-bit popcount for boundary move transforms.
#include <algorithm>
#include <atomic>
#include <chrono>
#include <cstdint>
...
int main(int argc,char**argv){
 try{
    if(argc<2){std::cerr<<"usage: chomp_sieve_v5 ppositions.bin [max-dimension] [checkpoint] [preload-checkpoint] [only-width] [only-height] [threads]\n";return 2;}
