"""Time a fresh 18x18 V8 run and verify the complete checkpoint against V5/V6."""
...
s={'state':'running','dimension':18,'workers':a.workers,'command':cmd,'started_at':datetime.datetime.now(datetime.timezone.utc).isoformat(),'seed_sha256':sha(a.seed),'base_sha256':sha(a.base),'expected_checkpoint_sha256':EXPECTED}
