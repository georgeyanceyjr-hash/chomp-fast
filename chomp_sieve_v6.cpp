// Experimental V6 candidate: precomputed corner transforms and immutable-batch corner prefilter.
...
int main(int argc,char**argv){
 try{
    if(argc<2){std::cerr<<"usage: chomp_sieve_v6_candidate ppositions.bin [max-dimension] [checkpoint] [preload-checkpoint] [only-width] [only-height] [threads]\n";return 2;}
